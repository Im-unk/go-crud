...
type SearchEngine interface {
	...
	IndexDocument(index string, data interface{}) error
	...
	// New method to delete a document by a unique identifier (e.g., email or username).
	DeleteDocumentByUniqueID(index string, uniqueIDField string, uniqueIDValue string) error
